...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { cpu: @computer.cpu, gpu: @computer.gpu, motherboard: @computer.motherboard } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { cpu: @computer.cpu, gpu: @computer.gpu, motherboard: @computer.motherboard } }
